# $Id: Assembler.pm,v 1.47.2.7 2009/09/22 00:25:56 Paulo Custodio Exp $
...
The list is passed to the L<CPU::Z80::Preprocessor> that takes care
of file includes and handles the %line and #line lines generated by external 
preprocessors like cpp or nasm. The result of this stage is a L<CPU::Z80::Assembler::Stream> 
of L<CPU::Z80::Assembler::Line> objects.

This stream of lines is passed on to the L<CPU::Z80::Assembler::Lexer>
to scan the input and return a L<CPU::Z80::Assembler::Stream> of 
L<CPU::Z80::Assembler::Token> objects.

The stream of tokens is passed on to L<CPU:Z80::Assembler::Parser> that parses the 
input and generates the object image in L<CPU::Z80::Assembler::Program>. 
Assembly macro expansion is handled at this stage by L<CPU::Z80::Assembler::Macro>.

The assembly program is composed by a list of L<CPU::Z80::Assembler::Segment>, each 
representing one named section of code. Each segment is composed by a list of L<CPU::Z80::Assembler::Opcode>, each representing one assembly instruction.
...
by L<CPU::Z80::Assembler::List> on standard output.
...
represented by L<CPU::Z80::Assembler::Expr>.

=back

The L<z80masm> program (installed as part of this module) calls the z80asm() function
